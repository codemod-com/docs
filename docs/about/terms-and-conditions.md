...
<head>
  <meta property='og:title' content='Terms and Conditions | Codemod.com'/>
...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Caartaa Inc., 480 E Okeefe St, Unit 216 East Palo Alto, CA US.
...
- **Website** refers to Codemod, accessible from [https://codemod.com](https://codemod.com/)
...
- By email: [privacy@codemod.com](mailto:privacy@codemod.com)
...
- **Website** refers to Codemod, accessible from [codemod.com](https://codemod.com/)
- **You** means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
