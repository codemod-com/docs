...
We also built codemod `mocha/vitest/migrate-configurations` using our Filemod engine, as jscodeshift does not allow creating and removing files.
...
The first two had a handful of Mocha.js test suites and we migrated them first to spot problems early in the development. Once the codemod was ready and accurate, we merged them into the Codemod Registry. Once codemods are published to the registry, they automatically become accessible to the community via Codemod.com VSCode Extension or CLI.
...
If you, just like us, are passioante about the future of software development, join our [community](https://codemod.com/community) or [team](https://codemod.notion.site/Join-Intuita-b9c9bf82d38341f8936744b6aac20dba).
